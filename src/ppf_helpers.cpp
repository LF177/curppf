...
{
    std::cout << "compute cur begin " << std::endl;
    if(PC->points.size() < 1)
    {
  ...
  //principalCurvaturesEstimation.setRadiusSearch(1.0);
    ...
    for(int i = 0; i < PC->points.size(); i++)
    {
        ...
        //PC->points[i].normal_x = principalCurvatures->points[i].principal_curvature_x;
        //PC->points[i].normal_y = principalCurvatures->points[i].principal_curvature_y;
        //PC->points[i].normal_z = principalCurvatures->points[i].principal_curvature_z;
